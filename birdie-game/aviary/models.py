...
class BirdCardTemplate(models.Model):
    ...
    first_food = models.ForeignKey("Food", related_name="birdcard_template_first_food", default=None, on_delete=models.SET_NULL, null=True)
    second_food = models.ForeignKey("Food", related_name="birdcard_template_second_food", default=None, on_delete=models.SET_NULL, null=True)
...
class BirdCard(models.Model):
    ...
    ability_type = models.CharField(max_length=1, choices=ABILITY_TYPES, default='w')
    direction_facing = models.CharField(max_length=1, choices=FACING_DIRECTION, default='f')
    first_food = models.ForeignKey("Food", related_name="birdcard_first_food", on_delete=models.SET_NULL, default=None, null=True)
    second_food = models.ForeignKey("Food", related_name="birdcard_second_food", on_delete=models.SET_NULL, default=None, null=True)
    third_food = models.ForeignKey("Food", related_name="birdcard_third_food", on_delete=models.SET_NULL, default=None, null=True)
    costs_one_food = models.BooleanField(default=False, help_text="Does this bird cost one food to play?")
